...
//v3 Controller
//const byte buttonsPins[buttonsCount] = {255,255,255,255,255,255,15,2,255,255,255,255,52,13,39,36,50,48,11,12,49,51,26,34,40,8,45,38}; //The pins of each of the buttons currently in existence
//const int buttonsDownState[buttonsCount] = {LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,HIGH}; //The state that the button is in when it's down (ie pressed)
//const byte ledPins[ledCount] = {255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,58,30,31,41,43,47,9,10,7,44,24,42}; //The pins of each of the KEDs currently in existence
//const byte lcdPins[8] = {255, 255, 255, 255, 255, 255, 255, 255}; //Set first one to 255 if not fitted

//v2 Controller
const byte buttonsPins[buttonsCount] = {28,30,29,41,45,53,49,42,46,36,37,35,8,10,5,7,255,255,255,255,255,255,15,2,255,255,255,255}; //The pins of each of the buttons currently in existence
const int buttonsDownState[buttonsCount] = {LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,LOW,HIGH}; //The state that the button is in when it's down (ie pressed)
const byte ledPins[ledCount] = {32,31,33,43,39,51,47,44,48,38,40,34,255,255,255,255,255,255,52,50,12,11,255,9,13,255,3,6,255,4,14,255}; //The pins of each of the KEDs currently in existence
